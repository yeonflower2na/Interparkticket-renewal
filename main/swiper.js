...
function mainVisualLoadImg() {
  if (mainVisualMatch.matches) {
    document
      ...
      .forEach((a, i) => {
        if (a.getAttribute("src") != `main/img/res-main-visual (${i + 1}).gif`) {
          a.setAttribute("src", `main/img/res-main-visual (${i + 1}).gif`);
        }
      });
  } else {
    document
      .querySelectorAll(".main-visual-swiper .swiper-slide img")
      .forEach((a, i) => {
        if (a.getAttribute("src") != `main/img/main-visual (${i + 1}).jpg`) {
          a.setAttribute("src", `main/img/main-visual (${i + 1}).jpg`);
        }
      });
  }
}
